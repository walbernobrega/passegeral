...
public class TransacaoService {
	...
	public List<Transacao> procuraPorDescricao(String descricao) {
		return repo.findByIdfilAndDescricaoContainingIgnoreCaseOrderByDescricao(PassegeralApplication._EMPRESA , descricao);
	}
